...
type VolumeSource struct {
	...
	// registered in Cubelet's volume.Manager.  Field number matches
	// Cubelet's cubebox.proto to ensure wire compatibility.
	PluginVolume  *PluginVolumeSource `protobuf:"bytes,11,opt,name=plugin_volume,json=pluginVolume,proto3" json:"plugin_volume,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VolumeSource) GetPluginVolume() *PluginVolumeSource {
	if x != nil {
...
// Mirrors cubelet.services.volumeplugin.v1.PluginVolumeSource for
// wire-format compatibility (same field numbers).
type PluginVolumeSource struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// driver is the registered plugin name (e.g. "cos", "nfs").
	Driver string `protobuf:"bytes,1,opt,name=driver,proto3" json:"driver,omitempty"`
	// options are driver-specific key-value pairs forwarded to the plugin.
	// MUST include "volume_id".
...
func (x *PluginVolumeSource) GetOptions() map[string]string {
	if x != nil {
		return x.Options
	}
	return nil
...
type GetSandboxNetworkRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// requestID reqID
	RequestID string `protobuf:"bytes,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	// ID of the Sandbox.
...
func (x *GetSandboxNetworkRequest) Reset() {
	*x = GetSandboxNetworkRequest{}
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetSandboxNetworkRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSandboxNetworkRequest) ProtoMessage() {}

func (x *GetSandboxNetworkRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[52]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSandboxNetworkRequest.ProtoReflect.Descriptor instead.
func (*GetSandboxNetworkRequest) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{52}
}

func (x *GetSandboxNetworkRequest) GetRequestID() string {
	if x != nil {
		return x.RequestID
	}
	return ""
...
func (x *GetSandboxNetworkRequest) GetSandboxID() string {
	if x != nil {
		return x.SandboxID
	}
	return ""
...
type GetSandboxNetworkResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// requestID reqID
	RequestID string `protobuf:"bytes,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	// ID of the Sandbox.
	SandboxID string `protobuf:"bytes,2,opt,name=sandboxID,proto3" json:"sandboxID,omitempty"`
	// Egress policy currently installed on the node, including the resolver
	// allow-out entries the runtime folds in. Absent when the lookup failed.
	CubeNetworkConfig *CubeNetworkConfig `protobuf:"bytes,3,opt,name=cube_network_config,json=cubeNetworkConfig,proto3,oneof" json:"cube_network_config,omitempty"`
	// Datapath policy generation for this sandbox's TAP device. It advances on
	// every accepted policy update, so a caller can prove an update landed.
	Generation uint32 `protobuf:"varint,4,opt,name=generation,proto3" json:"generation,omitempty"`
	// Ret.
	Ret           *v11.Ret `protobuf:"bytes,5,opt,name=ret,proto3" json:"ret,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetSandboxNetworkResponse) Reset() {
	*x = GetSandboxNetworkResponse{}
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetSandboxNetworkResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSandboxNetworkResponse) ProtoMessage() {}

func (x *GetSandboxNetworkResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSandboxNetworkResponse.ProtoReflect.Descriptor instead.
func (*GetSandboxNetworkResponse) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{53}
}

func (x *GetSandboxNetworkResponse) GetRequestID() string {
	if x != nil {
		return x.RequestID
	}
	return ""
...
func (x *GetSandboxNetworkResponse) GetSandboxID() string {
	if x != nil {
		return x.SandboxID
	}
	return ""
...
func (x *GetSandboxNetworkResponse) GetCubeNetworkConfig() *CubeNetworkConfig {
	if x != nil {
		return x.CubeNetworkConfig
	}
	return nil
...
func (x *GetSandboxNetworkResponse) GetGeneration() uint32 {
	if x != nil {
		return x.Generation
	}
	return 0
...
func (x *GetSandboxNetworkResponse) GetRet() *v11.Ret {
	if x != nil {
		return x.Ret
	}
	return nil
...
const file_api_services_cubebox_v1_cubebox_proto_rawDesc = "" +
	...
	"\x0evolume_sources\x18\x01 \x03(\v2*.cubelet.services.cubebox.v1.HostDirSourceR\rvolumeSources\"\xaf\x03\n" +
	"\fVolumeSource\x12N\n" +
	...
	"\x05image\x18\t \x01(\v2-.cubelet.services.images.v1.ImageVolumeSourceR\x05image\x12T\n" +
	"\rplugin_volume\x18\v \x01(\v2/.cubelet.services.cubebox.v1.PluginVolumeSourceR\fpluginVolume\"\xc0\x01\n" +
	"\x12PluginVolumeSource\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12V\n" +
	"\aoptions\x18\x02 \x03(\v2<.cubelet.services.cubebox.v1.PluginVolumeSource.OptionsEntryR\aoptions\x1a:\n" +
	...
	"\x18GetSandboxNetworkRequest\x12\x1c\n" +
	"\trequestID\x18\x01 \x01(\tR\trequestID\x12\x1c\n" +
	"\tsandboxID\x18\x02 \x01(\tR\tsandboxID\"\xaa\x02\n" +
	"\x19GetSandboxNetworkResponse\x12\x1c\n" +
	"\trequestID\x18\x01 \x01(\tR\trequestID\x12\x1c\n" +
	"\tsandboxID\x18\x02 \x01(\tR\tsandboxID\x12c\n" +
	"\x13cube_network_config\x18\x03 \x01(\v2..cubelet.services.cubebox.v1.CubeNetworkConfigH\x00R\x11cubeNetworkConfig\x88\x01\x01\x12\x1e\n" +
	"\n" +
	"generation\x18\x04 \x01(\rR\n" +
	"generation\x124\n" +
	"\x03ret\x18\x05 \x01(\v2\".cubelet.services.errorcode.v1.RetR\x03retB\x16\n" +
	"\x14_cube_network_config\"_\n" +
	"\tIDMapping\x12\x17\n" +
	...
	"\x06Update\x125.cubelet.services.cubebox.v1.UpdateCubeSandboxRequest\x1a6.cubelet.services.cubebox.v1.UpdateCubeSandboxResponse\x12\x82\x01\n" +
	"\x11GetSandboxNetwork\x125.cubelet.services.cubebox.v1.GetSandboxNetworkRequest\x1a6.cubelet.services.cubebox.v1.GetSandboxNetworkResponse\x12q\n" +
...
var file_api_services_cubebox_v1_cubebox_proto_goTypes = []any{
	...
	(*PluginVolumeSource)(nil),                // 38: cubelet.services.cubebox.v1.PluginVolumeSource
	...
	(*GetSandboxNetworkRequest)(nil),          // 58: cubelet.services.cubebox.v1.GetSandboxNetworkRequest
	(*GetSandboxNetworkResponse)(nil),         // 59: cubelet.services.cubebox.v1.GetSandboxNetworkResponse
	...
	nil,                          // 92: cubelet.services.cubebox.v1.PluginVolumeSource.OptionsEntry
	nil,                          // 93: cubelet.services.cubebox.v1.RunCubeSandboxRequest.AnnotationsEntry
	nil,                          // 94: cubelet.services.cubebox.v1.RunCubeSandboxRequest.LabelsEntry
	nil,                          // 95: cubelet.services.cubebox.v1.RunCubeSandboxResponse.ExtInfoEntry
	nil,                          // 96: cubelet.services.cubebox.v1.DestroyCubeSandboxRequest.AnnotationsEntry
	nil,                          // 97: cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ExtInfoEntry
	nil,                          // 98: cubelet.services.cubebox.v1.CubeSandbox.LabelsEntry
	nil,                          // 99: cubelet.services.cubebox.v1.Container.LabelsEntry
	nil,                          // 100: cubelet.services.cubebox.v1.CubeSandboxFilter.LabelSelectorEntry
	nil,                          // 101: cubelet.services.cubebox.v1.UpdateCubeSandboxRequest.AnnotationsEntry
	nil,                          // 102: cubelet.services.cubebox.v1.UpdateCubeSandboxResponse.ExtInfoEntry
	nil,                          // 103: cubelet.services.cubebox.v1.GetStorageMetricsResponse.MetricsEntry
	(*v1.ImageSpec)(nil),         // 104: cubelet.services.images.v1.ImageSpec
	(*v1.ImageVolumeSource)(nil), // 105: cubelet.services.images.v1.ImageVolumeSource
	(*v11.Ret)(nil),              // 106: cubelet.services.errorcode.v1.Ret
}
var file_api_services_cubebox_v1_cubebox_proto_depIdxs = []int32{
	...
	104, // 15: cubelet.services.cubebox.v1.ContainerConfig.image:type_name -> cubelet.services.images.v1.ImageSpec
	...
	105, // 39: cubelet.services.cubebox.v1.VolumeSource.image:type_name -> cubelet.services.images.v1.ImageVolumeSource
	38,  // 40: cubelet.services.cubebox.v1.VolumeSource.plugin_volume:type_name -> cubelet.services.cubebox.v1.PluginVolumeSource
	92,  // 41: cubelet.services.cubebox.v1.PluginVolumeSource.options:type_name -> cubelet.services.cubebox.v1.PluginVolumeSource.OptionsEntry
	37,  // 42: cubelet.services.cubebox.v1.Volume.volume_source:type_name -> cubelet.services.cubebox.v1.VolumeSource
	39,  // 43: cubelet.services.cubebox.v1.RunCubeSandboxRequest.volumes:type_name -> cubelet.services.cubebox.v1.Volume
	26,  // 44: cubelet.services.cubebox.v1.RunCubeSandboxRequest.containers:type_name -> cubelet.services.cubebox.v1.ContainerConfig
	93,  // 45: cubelet.services.cubebox.v1.RunCubeSandboxRequest.annotations:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxRequest.AnnotationsEntry
	94,  // 46: cubelet.services.cubebox.v1.RunCubeSandboxRequest.labels:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxRequest.LabelsEntry
	43,  // 47: cubelet.services.cubebox.v1.RunCubeSandboxRequest.cube_network_config:type_name -> cubelet.services.cubebox.v1.CubeNetworkConfig
	106, // 48: cubelet.services.cubebox.v1.RunCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	95,  // 49: cubelet.services.cubebox.v1.RunCubeSandboxResponse.ext_info:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxResponse.ExtInfoEntry
	42,  // 50: cubelet.services.cubebox.v1.RunCubeSandboxResponse.port_mappings:type_name -> cubelet.services.cubebox.v1.PortMapping
	44,  // 51: cubelet.services.cubebox.v1.CubeNetworkConfig.rules:type_name -> cubelet.services.cubebox.v1.EgressRule
	45,  // 52: cubelet.services.cubebox.v1.EgressRule.match:type_name -> cubelet.services.cubebox.v1.EgressRuleMatch
	46,  // 53: cubelet.services.cubebox.v1.EgressRule.action:type_name -> cubelet.services.cubebox.v1.EgressRuleAction
	47,  // 54: cubelet.services.cubebox.v1.EgressRuleAction.inject:type_name -> cubelet.services.cubebox.v1.EgressRuleInject
	96,  // 55: cubelet.services.cubebox.v1.DestroyCubeSandboxRequest.annotations:type_name -> cubelet.services.cubebox.v1.DestroyCubeSandboxRequest.AnnotationsEntry
	53,  // 56: cubelet.services.cubebox.v1.DestroyCubeSandboxRequest.filter:type_name -> cubelet.services.cubebox.v1.CubeSandboxFilter
	106, // 57: cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	97,  // 58: cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ext_info:type_name -> cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ExtInfoEntry
	51,  // 59: cubelet.services.cubebox.v1.CubeSandbox.containers:type_name -> cubelet.services.cubebox.v1.Container
	42,  // 60: cubelet.services.cubebox.v1.CubeSandbox.port_mappings:type_name -> cubelet.services.cubebox.v1.PortMapping
	98,  // 61: cubelet.services.cubebox.v1.CubeSandbox.labels:type_name -> cubelet.services.cubebox.v1.CubeSandbox.LabelsEntry
	...
	99,  // 64: cubelet.services.cubebox.v1.Container.labels:type_name -> cubelet.services.cubebox.v1.Container.LabelsEntry
	...
	100, // 68: cubelet.services.cubebox.v1.CubeSandboxFilter.label_selector:type_name -> cubelet.services.cubebox.v1.CubeSandboxFilter.LabelSelectorEntry
	53,  // 69: cubelet.services.cubebox.v1.ListCubeSandboxRequest.filter:type_name -> cubelet.services.cubebox.v1.CubeSandboxFilter
	61,  // 70: cubelet.services.cubebox.v1.ListCubeSandboxRequest.option:type_name -> cubelet.services.cubebox.v1.ListCubeSandboxOption
	50,  // 71: cubelet.services.cubebox.v1.ListCubeSandboxResponse.items:type_name -> cubelet.services.cubebox.v1.CubeSandbox
	101, // 72: cubelet.services.cubebox.v1.UpdateCubeSandboxRequest.annotations:type_name -> cubelet.services.cubebox.v1.UpdateCubeSandboxRequest.AnnotationsEntry
	43,  // 73: cubelet.services.cubebox.v1.UpdateCubeSandboxRequest.cube_network_config:type_name -> cubelet.services.cubebox.v1.CubeNetworkConfig
	106, // 74: cubelet.services.cubebox.v1.UpdateCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	102, // 75: cubelet.services.cubebox.v1.UpdateCubeSandboxResponse.ext_info:type_name -> cubelet.services.cubebox.v1.UpdateCubeSandboxResponse.ExtInfoEntry
	43,  // 76: cubelet.services.cubebox.v1.GetSandboxNetworkResponse.cube_network_config:type_name -> cubelet.services.cubebox.v1.CubeNetworkConfig
	106, // 77: cubelet.services.cubebox.v1.GetSandboxNetworkResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	106, // 78: cubelet.services.cubebox.v1.ExecCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	40,  // 79: cubelet.services.cubebox.v1.AppSnapshotRequest.create_request:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxRequest
	106, // 80: cubelet.services.cubebox.v1.AppSnapshotResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	106, // 81: cubelet.services.cubebox.v1.CommitSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	106, // 82: cubelet.services.cubebox.v1.RollbackSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	70,  // 83: cubelet.services.cubebox.v1.CleanupTemplateRequest.objects:type_name -> cubelet.services.cubebox.v1.CowObjectRef
	106, // 84: cubelet.services.cubebox.v1.CleanupTemplateResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	70,  // 85: cubelet.services.cubebox.v1.ListSandboxSnapshotsRequest.objects:type_name -> cubelet.services.cubebox.v1.CowObjectRef
	106, // 86: cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	74,  // 87: cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse.objects:type_name -> cubelet.services.cubebox.v1.CowObjectStatus
	106, // 88: cubelet.services.cubebox.v1.ListLocalSnapshotsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	77,  // 89: cubelet.services.cubebox.v1.ListLocalSnapshotsResponse.snapshots:type_name -> cubelet.services.cubebox.v1.LocalSnapshotInfo
	106, // 90: cubelet.services.cubebox.v1.GetLocalSnapshotResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	77,  // 91: cubelet.services.cubebox.v1.GetLocalSnapshotResponse.snapshot:type_name -> cubelet.services.cubebox.v1.LocalSnapshotInfo
	106, // 92: cubelet.services.cubebox.v1.GetStorageMetricsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	103, // 93: cubelet.services.cubebox.v1.GetStorageMetricsResponse.metrics:type_name -> cubelet.services.cubebox.v1.GetStorageMetricsResponse.MetricsEntry
	83,  // 94: cubelet.services.cubebox.v1.SandboxStorageInfo.volumes:type_name -> cubelet.services.cubebox.v1.StorageVolumeInfo
	106, // 95: cubelet.services.cubebox.v1.InspectStorageVolumesResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	84,  // 96: cubelet.services.cubebox.v1.InspectStorageVolumesResponse.sandboxes:type_name -> cubelet.services.cubebox.v1.SandboxStorageInfo
	106, // 97: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	88,  // 98: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse.orphans:type_name -> cubelet.services.cubebox.v1.StorageOrphanEntry
	...
	58,  // 103: cubelet.services.cubebox.v1.CubeboxMgr.GetSandboxNetwork:input_type -> cubelet.services.cubebox.v1.GetSandboxNetworkRequest
	...
	59,  // 119: cubelet.services.cubebox.v1.CubeboxMgr.GetSandboxNetwork:output_type -> cubelet.services.cubebox.v1.GetSandboxNetworkResponse
	63,  // 120: cubelet.services.cubebox.v1.CubeboxMgr.Exec:output_type -> cubelet.services.cubebox.v1.ExecCubeSandboxResponse
	65,  // 121: cubelet.services.cubebox.v1.CubeboxMgr.AppSnapshot:output_type -> cubelet.services.cubebox.v1.AppSnapshotResponse
	67,  // 122: cubelet.services.cubebox.v1.CubeboxMgr.CommitSandbox:output_type -> cubelet.services.cubebox.v1.CommitSandboxResponse
	69,  // 123: cubelet.services.cubebox.v1.CubeboxMgr.RollbackSandbox:output_type -> cubelet.services.cubebox.v1.RollbackSandboxResponse
	72,  // 124: cubelet.services.cubebox.v1.CubeboxMgr.CleanupTemplate:output_type -> cubelet.services.cubebox.v1.CleanupTemplateResponse
	75,  // 125: cubelet.services.cubebox.v1.CubeboxMgr.ListSandboxSnapshots:output_type -> cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse
	78,  // 126: cubelet.services.cubebox.v1.CubeboxMgr.ListLocalSnapshots:output_type -> cubelet.services.cubebox.v1.ListLocalSnapshotsResponse
	80,  // 127: cubelet.services.cubebox.v1.CubeboxMgr.GetLocalSnapshot:output_type -> cubelet.services.cubebox.v1.GetLocalSnapshotResponse
	82,  // 128: cubelet.services.cubebox.v1.CubeboxMgr.GetStorageMetrics:output_type -> cubelet.services.cubebox.v1.GetStorageMetricsResponse
	86,  // 129: cubelet.services.cubebox.v1.CubeboxMgr.InspectStorageVolumes:output_type -> cubelet.services.cubebox.v1.InspectStorageVolumesResponse
	89,  // 130: cubelet.services.cubebox.v1.CubeboxMgr.CleanupOrphanStorageFiles:output_type -> cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse
...
func file_api_services_cubebox_v1_cubebox_proto_init() {
	...
	file_api_services_cubebox_v1_cubebox_proto_msgTypes[34].OneofWrappers = []any{}
	...
	file_api_services_cubebox_v1_cubebox_proto_msgTypes[48].OneofWrappers = []any{}
	file_api_services_cubebox_v1_cubebox_proto_msgTypes[50].OneofWrappers = []any{}
	file_api_services_cubebox_v1_cubebox_proto_msgTypes[53].OneofWrappers = []any{}
	type x struct{}
